...
`, testName),
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.netbox_console_ports.by_name", "console_ports.0.occupied", "false"),
					...
					resource.TestCheckResourceAttr("data.netbox_console_ports.by_device_id", "console_ports.0.occupied", "false"),
					...
					resource.TestCheckResourceAttr("data.netbox_console_ports.by_device_id", "console_ports.1.occupied", "false"),
					...
					resource.TestCheckResourceAttr("data.netbox_console_ports.by_device_id", "console_ports.2.occupied", "false"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.netbox_console_ports.regex_test", "console_ports.0.occupied", "false"),
				),
			},
			{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.netbox_console_ports.device2_only", "console_ports.0.occupied", "false"),
				),
			},
		},
	})
