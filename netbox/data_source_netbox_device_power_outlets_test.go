...
`, testName),
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.netbox_device_power_outlets.by_name", "power_outlets.0.occupied", "false"),
					...
					resource.TestCheckResourceAttr("data.netbox_device_power_outlets.by_device_id", "power_outlets.0.occupied", "false"),
					...
					resource.TestCheckResourceAttr("data.netbox_device_power_outlets.by_device_id", "power_outlets.1.occupied", "false"),
					...
					resource.TestCheckResourceAttr("data.netbox_device_power_outlets.by_device_id", "power_outlets.2.occupied", "false"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.netbox_device_power_outlets.regex_test", "power_outlets.0.occupied", "false"),
				),
			},
			{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.netbox_device_power_outlets.device2_only", "power_outlets.0.occupied", "false"),
				),
			},
		},
	})
