...
// 					resource.TestCheckResourceAttr("netbox_power_port_template.test", "type", "100base-tx"),
...
// func TestAccPowerPortTemplate_opts(t *testing.T) {
...
// 					resource.TestCheckResourceAttr("netbox_power_port_template.test", "type", "100base-tx"),
// 					resource.TestCheckResourceAttr("netbox_power_port_template.test", "mgmt_only", "true"),
// 					resource.TestCheckResourceAttrPair("netbox_power_port_template.test", "device_type_id", "netbox_device_type.test", "id"),
// 				),
// 			},
// 			{
...
// 					resource.TestCheckResourceAttr("netbox_power_port_template.test", "label", fmt.Sprintf("%s label", testName)),
// 					resource.TestCheckResourceAttr("netbox_power_port_template.test", "type", "100base-tx"),
// 					resource.TestCheckResourceAttr("netbox_power_port_template.test", "mgmt_only", "false"),
